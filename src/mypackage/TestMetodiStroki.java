...
public class TestMetodiStroki {
    public static void main(String[] args) {
        ...
        String arr = "My name is %s I'm %d years old";
        int age = 30;
        String name = "Ivan";

        System.out.println(String.format(arr, name, age));
        System.out.println(String.format(arr, "Vasya", 10));
